...
return array (
  ...
  'Delete invitation' => '',
  'Delete invitation?' => '',
  'Delete spaces which are owned by this user' => 'Delete communities which are owned by this user',
  'Deleted invitation' => '',
  'Deleted users' => '',
  'Disable' => '',
  'Disabled' => '',
  ...
  'If this option is not selected, the ownership of the spaces will be transferred to your account.' => 'If this option is not selected, the ownership of the communities will be transferred to your account.',
  'Impersonate' => '',
  ...
  'The user is the owner of these spaces:' => 'The user is the owner of these communities:',
  'This overview contains a list of each registered user with actions to view, edit and delete users.' => '',
  'This user owns no spaces.' => 'This user owns no communities.',
  'Unapproved' => '',
  'User deletion process queued.' => '',
  'User is already a member of this group.' => '',
  'User not found!' => '',
  'Users' => '',
  'Users can be assigned to different groups (e.g. teams, departments etc.) with specific standard spaces, group managers and permissions.' => 'Users can be assigned to different groups (e.g. teams, departments etc.) with specific standard communities, group managers and permissions.',
